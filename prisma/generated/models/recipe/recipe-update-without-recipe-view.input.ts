...
import { DishTypeUpdateOneRequiredWithoutRecipesNestedInput } from '../dish-type/dish-type-update-one-required-without-recipes-nested.input';

@InputType()
export class RecipeUpdateWithoutRecipeViewInput {
    ...
    @Field(() => DishTypeUpdateOneRequiredWithoutRecipesNestedInput, {nullable:true})
    @Type(() => DishTypeUpdateOneRequiredWithoutRecipesNestedInput)
