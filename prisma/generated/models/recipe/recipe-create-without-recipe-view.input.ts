...
import { RecipeLikeCreateNestedManyWithoutRecipeInput } from '../recipe-like/recipe-like-create-nested-many-without-recipe.input';
...
@InputType()
export class RecipeCreateWithoutRecipeViewInput {
    ...
    @Field(() => RecipeLikeCreateNestedManyWithoutRecipeInput, {nullable:true})
    @Type(() => RecipeLikeCreateNestedManyWithoutRecipeInput)
