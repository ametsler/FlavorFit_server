...
import { CommentLikeCommentIdUserIdCompoundUniqueInput } from './comment-like-comment-id-user-id-compound-unique.input';
...
export class CommentLikeWhereUniqueInput {
    ...
    @Field(() => CommentLikeCommentIdUserIdCompoundUniqueInput, {nullable:true})
