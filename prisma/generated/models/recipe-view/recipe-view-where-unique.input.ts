...
import { RecipeViewRecipeIdUserIdCompoundUniqueInput } from './recipe-view-recipe-id-user-id-compound-unique.input';
...
@InputType()
export class RecipeViewWhereUniqueInput {

    @Field(() => String, {nullable:true})
    id?: string;

    @Field(() => RecipeViewRecipeIdUserIdCompoundUniqueInput, {nullable:true})
    recipeId_userId?: RecipeViewRecipeIdUserIdCompoundUniqueInput;
